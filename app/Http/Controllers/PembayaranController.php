...
class PembayaranController extends Controller
{
    ...
    public function store(Request $req)
    {
        ...
        $req->validate([
         ...
         if(Siswa::where('nisn',$req->nisn)->exists() == false):
           return back()->with('Terjadi Kesalahan!', 'Siswa dengan NISN ini Tidak di Temukan');
            exit;
         endif;
         ...
         return back()->with('Berhasil!', 'Pembayaran Berhasil di Tambahkan!');
    }
    ...
    public function update(Request $req, $id)
    {
        ...
        $req->validate([
         ...
         return back()->with('Berhasil!', 'Pembayaran berhasil di Edit');
    }
